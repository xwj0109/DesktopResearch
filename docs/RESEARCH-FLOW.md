...
- **Research Development** is where you test scripts and code with the agent and define the research precisely. It stays flexible, and you can go back to Ideas and Literature as often as needed.
  ...
  - **Which idea:** a **developing** bar across the stage states the idea being worked on. It is the window's choice, else the Literature focus, else the first pursued idea. Switching the idea switches the Pi conversation and every pane. Each idea's conversation keeps running.
...
- **Send to production** (decided 2026-09-25) is explicit: **Send to production…** in the Research Development bar, or `production_commit`.
